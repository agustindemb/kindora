  ...
  async create(
    ...
    try {
      ...
      const newAct: ActivitySelect = {
        ...
        locationId: locId,
        startsAt: activityData.startsAt ? new Date(activityData.startsAt) : null,
        endsAt: activityData.endsAt ? new Date(activityData.endsAt) : null,
        ...
        recurrenceDays: activityData.recurrenceDays || null,
        recurrenceEnd: activityData.recurrenceEnd ? new Date(activityData.recurrenceEnd) : null,
